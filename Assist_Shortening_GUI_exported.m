    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            handleSpecs = { ...
                ...
                'enable_drives_right', [base_name_low 'Constant54_Value'], 'lowlevel_params',app.tcClient_lowlevel; ...
                ...
                'enable_data_collection', [base_name_low 'Constant4_Value'], 'lowlevel_params',app.tcClient_lowlevel; ...
                'pd_kp_left', [base_name_low 'Manual_Kp1_Value'], 'lowlevel_params',app.tcClient_lowlevel; ...
                'pd_kp_right', [base_name_low 'Manual_Kp2_Value'], 'lowlevel_params',app.tcClient_lowlevel ...
                'pd_kd_left', [base_name_low 'Manual_Kd_Value'], 'lowlevel_params',app.tcClient_lowlevel; ...
                'pd_kd_right', [base_name_low 'Manual_Kd1_Value'], 'lowlevel_params',app.tcClient_lowlevel ...
                };
            app.writeMap = struct;
            app.GuiOutputHandle = [];
